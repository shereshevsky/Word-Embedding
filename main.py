...
if __name__ == '__main__':
    ...
    model = CNN(batch_size=batch_size, output_size=output_size, in_channels=1, out_channels=64, kernel_heights=(3, 4, 5),
                stride=1, padding=0, keep_probab=0.2, vocab_size=200000, embedding_length=embedding_length,
                weights=embedding_matrix, train_w2v_weights=True)
